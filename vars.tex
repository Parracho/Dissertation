...
\thesistitle{Modified gravity from the viewpoint of backreaction}

% Your thesis type Doctoral Thesis or Masters Thesis \ttype
\thesistype{Masters Thesis}

% Your supervisor's name
\supervisor[mailto:jpmimoso@fc.ul.pt]{José \textsc{Mimoso}}

% Your supervisor's name
% To hide the Co-Supervisor field, just comment out \cosupervisor
\cosupervisor[mailto:ppavelin@fc.up.pt]{Pedro \textsc{Avelino}}

% Your degree name
\degree{MSc. Physics}

% Your name
\authors[mailto:up202203990@fc.up.pt]{Bruno \textsc{Parracho}}
